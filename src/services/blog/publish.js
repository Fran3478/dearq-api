import { PostError, PostCheckError, PostUpdateError } from "../../errors/index.js"
...
export default async ({id}) => {
    try {
        ...
        if(err instanceof PostUpdateError || err instanceof PostCheckError) throw new PostError(err.message, err.orig_error)
